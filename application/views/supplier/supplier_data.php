                    ...
                    foreach ($row->result() as $key => $value) {?> 
                        <tr>
                            ...
                            <th class="text-center" width="160px">
                                <a href="<?=site_url('supplier/edit/'.$value->supplier_id)?>" class="btn btn-primary btn-xs">
                                    <i class="fa fa-pencil"></i> Edit
                                </a>
                                <a href="<?=site_url('supplier/delete/'.$value->supplier_id)?>" onclick="return confirm('Are you sure to remove the data?')" class="btn btn-danger btn-xs">
